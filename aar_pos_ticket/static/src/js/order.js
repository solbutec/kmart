...
odoo.define('aar_pos_ticket_receipt.order', function (require) {
    ...
    models.Order = models.Order.extend({
        ...
        get_subtotal_price: function() {
            return round_pr(this.orderlines.reduce((function(sum, orderLine) {
                return sum + (orderLine.get_unit_price() *  orderLine.get_quantity());
            }), 0), this.pos.currency.rounding);
        },
       /* get_total_price_amount: function(){
           var subtotal = this.get_subtotal_price();
           var total_discount =  this.get_order_discount();
           var total = subtotal-total_discount;
           return total;
        },        */  
    });
    ...
    models.Orderline = models.Orderline.extend({
        ...
        get_order_line_total_price: function(){
